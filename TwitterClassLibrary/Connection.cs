...
namespace TwitterClassLibrary.Connection
{
    public class DBConnect
    {
        // Main Connection String - used for the published web application and project submissions.
        //String SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa20_3342_tug92197;User id=tug92197;Password=aye4dooTho";

        // Home Connection String - used for working from home using SSH Tunneling.
        String SqlConnectString = "server=127.0.0.1,5555;Database=fa20_3342_tug92197;User id=tug92197;Password=aye4dooTho";
